...
static void mavlink_test_gios_memo(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_gios_memo_t packet_in = {
		17235,17339,17443
    };
	mavlink_gios_memo_t packet1, packet2;
	...
	mavlink_msg_gios_memo_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_gios_memo_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gios_memo_pack(system_id, component_id, &msg , packet1.version , packet1.status , packet1.cam_mode );
	mavlink_msg_gios_memo_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gios_memo_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.version , packet1.status , packet1.cam_mode );
	mavlink_msg_gios_memo_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_gios_memo_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_gios_memo_send(MAVLINK_COMM_1 , packet1.version , packet1.status , packet1.cam_mode );
	mavlink_msg_gios_memo_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
{
	mavlink_test_gios_memo(system_id, component_id, last_msg);
